        ...
        <div class="content-header">
            <div class="container-fluid">
                <h2 class="text-center py-3 text-primary">
                    <?= isset($data_divisi) ? "Edit Divisi" : "Tambah Divisi" ?>
                </h2>
                        ...
                        <form method="post" class="mx-auto" style="max-width:400px;">
                            <div class="mb-3">
                                ...
                                <input type="text" name="kode" class="form-control" required
                                    value="<?= $data_divisi['kode'] ?? '' ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nama Divisi</label>
                                <input type="text" name="nama" class="form-control" required
                                    value="<?= $data_divisi['nama'] ?? '' ?>">
                            </div>
                            <button type="submit" class="btn btn-primary shadow-sm rounded-3">
                                <i class="fas fa-save me-2"></i> <?= isset($data_divisi) ? "Update" : "Simpan" ?>
                            </button>
                            <a href="index.php?page=index_divisi" class="btn btn-outline-secondary shadow-sm rounded-3 ms-2">
