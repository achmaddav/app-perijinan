    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <h2 class="text-center py-3 text-primary">Daftar Divisi</h2>
                ...
                <div class="card shadow-lg border-0 rounded-3">
                    <div class="card-body">
                        <a href="/app-perijinan/add_divisi" class="btn btn-sm btn-success mb-3 shadow-sm">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-perizinan" class="table table-hover table-bordered align-middle text-center">
                                ...
                                <tbody>
                                    <?php if (count($stmt) > 0): ?>
                                        <?php $no = 1; foreach ($stmt as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.php?page=edit_divisi&id=<?= $row['id'] ?>" 
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="4">Tidak ada data divisi.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content shadow-lg border-0 rounded-3">
      ...
      <div class="modal-body text-center">
        <p>Apakah Anda yakin ingin menghapus divisi <strong id="namaDivisi"></strong>?</p>
      </div>
...
<script src="/app-perijinan/assets/js/admin/divisi.js?v=<?= time(); ?>"></script>
