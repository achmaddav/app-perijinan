    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <h2 class="text-center text-primary py-3">Ajukan Cuti</h2>
            </div>
        </div>
                        ...
                        <div class="card shadow-lg border-0 rounded-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/app-perijinan/insert_cuti" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        <label for="jabatan" class="col-md-4 col-form-label">Unit Kerja</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control shadow-sm" id="jabatan" 
                                    ...
                                    <div class="row mb-3">
                                        <label for="jabatan" class="col-md-4 col-form-label">Masa Kerja</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control shadow-sm" id="jabatan" 
                                    ...
                                    <div class="row mb-3">
                                        <label for="dari_tanggal" class="col-md-4 col-form-label">Sampai Tanggal</label>
                                        <div class="col-md-8">
